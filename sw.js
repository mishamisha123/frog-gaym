const CACHE='froggy-arcade-v37-loan-reserve-trusted-time';
const CORE=['./','./index.html','./styles.css?v=37','./app.js?v=37','./manifest.webmanifest','./refresh.html','./icons/icon-192.png','./icons/icon-512.png'];
