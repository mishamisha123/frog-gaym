const CACHE='froggy-arcade-v38-audio-accelerating-crash-protection';
const CORE=['./','./index.html','./styles.css?v=38','./app.js?v=38','./manifest.webmanifest','./refresh.html','./icons/icon-192.png','./icons/icon-512.png'];
